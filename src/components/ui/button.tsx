  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-primary-foreground hover:scale-105 shadow-medium hover:shadow-glow font-semibold",
        ...
        contrast: "border border-foreground/60 text-foreground hover:bg-foreground hover:text-background shadow-soft",
        ghost: "hover:bg-accent hover:text-accent-foreground",
        link: "text-primary underline-offset-4 hover:underline hover:text-primary-hover",
        premium: "bg-gradient-hero text-white hover:scale-105 shadow-medium hover:shadow-glow font-semibold",
        card: "bg-card hover:bg-gradient-card border border-border hover:border-primary/20 shadow-soft hover:shadow-medium",
      },
      size: {
        ...
        icon: "h-10 w-10",
        hero: "h-14 rounded-xl px-10 text-lg font-semibold",
      },
    },
    defaultVariants: {
      variant: "default",
